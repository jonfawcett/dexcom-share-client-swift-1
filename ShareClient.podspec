...
Pod::Spec.new do |spec|
  ...
  spec.homepage      = "https://github.com/nudgebg/dexcom-share-client-swift"
  spec.license       = "MIT"
  spec.author        = "jonfawcett"
  spec.platform      = :ios, "13"
  spec.source        = { :git => "https://github.com/nudgebg/dexcom-share-client-swift.git", :tag => "v#{spec.version}" }
